      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            buildVSpacer(20),
            _buildTextHeader(title: 'Car Selected', size: 17, fontWeight: FontWeight.w500),
            buildVSpacer(15),
            Padding(
                        ...
                        Row(
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                _buildTextHeader(title: 'Ford Figo RJ1UE0900', size: 17, fontWeight: FontWeight.w600),
                                _buildTextHeader(title: 'RJ1UE0900', size: 17, fontWeight: FontWeight.w400),
