...
import 'package:car_rental/share_car_rental/scrollable_clean_calendar.dart';
...
class _ModifyListingScreenState extends State<ModifyListingScreen> {
  ...
  bool isSecondButtonSelected = true; // Set this to true to open the Calendar tab by default
  String content = '';
  @override
  void initState() {
    super.initState();
