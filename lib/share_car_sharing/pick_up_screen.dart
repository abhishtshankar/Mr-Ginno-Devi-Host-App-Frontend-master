...
import 'package:car_rental/share_car_sharing/drop_off_screen.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildTextHeader(title: 'Pick-Up', size: 18, fontWeight: FontWeight.w600),
            _buildSearchBar(),
            _buildListTile(icon: AssetImage('assets/target.png'),
                text: 'Use Current location'),
            _buildListTile(icon: AssetImage('assets/timer.png'),
