...
import 'package:car_rental/share_car_sharing/stop_over_screen.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildTextHeader(title: 'Route', size: 18, fontWeight: FontWeight.w600),
            Container(
              width: double.infinity,
              child: Image(image: AssetImage('assets/routeMap.png')),
            ),
            _buildTextHeader(title: 'What is your route ?', size: 22, fontWeight: FontWeight.w600),
            _buildRouteOption('2hr 18 min-Tolls', '129 km -NH75 and NH 69 ', 0),
            _buildRouteOption('2hr 41 min-No Tolls', '135 km -NH75 and NH 69 ', 1),
          ],
        ),
      ),
    );
