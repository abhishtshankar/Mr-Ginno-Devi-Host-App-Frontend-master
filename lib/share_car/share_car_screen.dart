...
import 'package:car_rental/share_car_sharing/pick_up_screen.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            Container(
              height: 1.0,
              color: Colors.grey, // Change the color to your desired underline color
              margin: EdgeInsets.symmetric(horizontal: 20.0), // Adjust the horizontal margin as needed
            ),
            buildVSpacer(40),
            GestureDetector(
              onTap: (){
