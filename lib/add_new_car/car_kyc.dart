import 'package:car_rental/add_new_car/address_proof.dart';
import 'package:car_rental/add_new_car/car_document_details.dart';
import 'package:car_rental/add_new_car/dl_car_details.dart';
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Color(0xff245196), // Add your desired background color here
                          ...
                          child: Row(
                            children: [
                              Column(
                                children: [
                                  Image(image: AssetImage('assets/Group 116.png')),
                                  Text(
                                    'Car  Document',
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            ...
                            child: Row(
                              children: [
                                Image(image: AssetImage('assets/Group 114.png')),
                                buildHSpacer(10),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                          ...
                          GestureDetector(
                            ...
                            child: Row(
                              children: [
                                Image(image: AssetImage('assets/Group 112.png')),
                                buildHSpacer(10),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                          ...
                          GestureDetector(
                            ...
                            child: Row(
                              children: [
                                Image(image: AssetImage('assets/Group 115.png')),
                                buildHSpacer(10),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
