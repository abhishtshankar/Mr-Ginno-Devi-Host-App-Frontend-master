              ...
              Row(
                ...
                children: [
                  ElevatedButton(
                    ...
                    child: Row(
                      children: [
                        Image(image: AssetImage('assets/camera.png'), color: Colors.white,),
                         buildHSpacer(10),
                        Text('Click', style: GoogleFonts.poppins(color: Colors.white),),
                      ],
                    ),
                  ),
                  ElevatedButton(
                    ...
                    child:  Row(
                      children: [
                        Image(image: AssetImage('assets/gallery.png'), color: Colors.white,),
                        buildHSpacer(10),
                        Text('Gallery', style: GoogleFonts.poppins(color: Colors.white),),
                      ],
                    ),
                  ),
                ],
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              Spacer(),
                              Image(image: AssetImage('assets/Group 112.png'), color: Colors.white,),
