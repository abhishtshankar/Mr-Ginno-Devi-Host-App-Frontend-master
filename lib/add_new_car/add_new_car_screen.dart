import 'package:car_rental/add_new_car/car_added_screen.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _buildTextHeader(title: 'You can find the chassis number (17 digit number) on your RC Card', fontWeight: FontWeight.w400),
            buildVSpacer(20),
            _buildTextHeader(title: 'How many days a month do you plan to share your car?'),
            buildVSpacer(10),
            Padding(
            ...
            _buildTextHeader(title: 'This field is optional', fontWeight: FontWeight.w400),
            buildVSpacer(15),
            CheckboxListTile(
