...
import 'package:car_rental/add_new_car/car_kyc.dart';
import 'package:car_rental/bottom_navigations/bottom_navbar_items/home.dart';
              ...
              Column(
                ...
                children: [
                  ElevatedButton(
                    ...
                    child:  Row(
                      children: [
                        Image(image: AssetImage('assets/gallery.png'), color: Colors.black,),
                        buildHSpacer(10),
                        Text('Gallery', style: GoogleFonts.poppins(color: Colors.black),),
                      ],
                    ),
                  ),
                  SizedBox(height: 5, ),
                  ElevatedButton(
                    ...
                    child: Row(
                      children: [
                        Image(image: AssetImage('assets/camera2.png'), color: Colors.black,),
                        buildHSpacer(10),
                        Text('Camera', style: GoogleFonts.poppins(color: Colors.black),),
                      ],
                    ),
                  ),
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Image(
                    image: AssetImage('assets/white_car.png'), // Set your desired height
                  ),
                  Spacer(),
                          ...
                          child: Column(
                            children: [
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: TextStyle(
                                            fontSize: screenWidth * 0.028, // Adjust the font size as needed
                              ...
                              Padding(
                                ...
                                child: Row(
                                  children: [
                                    Image(image: AssetImage('assets/camera2.png'),
                                        color: Colors.white
                                    ),
                                    buildHSpacer(10),
                                    Column(
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 18.0),
              child: _buildText(title: 'Please refer pictures for uploading image of car', size: 13,),
            ),
            buildVSpacer(15),
            Container(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage('assets/car_thumbnail.png'), // Replace with your image URLs
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 18.0),
              child: _buildText(title: 'How to click images', size: 14,),
            ),

            Padding(
              padding: const EdgeInsets.only(left: 10.0, right: 10),
              child: Image(
                image: AssetImage('assets/Rectangle 3790.png'), // Set your desired height
              ),
            ),
            buildVSpacer(20),
